package com.routemobile.cryptotradeconsumerservice.controller;

import com.routemobile.cryptotradeconsumerservice.model.CryptoTradeData;
import com.routemobile.cryptotradeconsumerservice.service.CryptoTradeDataService;
...
@RequestMapping("/api/v1/crypto-trade-data")
@RestController
public class CryptoTradeController {

  private final CryptoTradeDataService cryptoTradeDataService;

  public CryptoTradeController(CryptoTradeDataService cryptoTradeDataService) {
   ...
   * <pre>
   *   Request URL:
   *   http://localhost:12350/api/v1/crypto-trade-data?page=0&size=10&sort=conversionPair,asc
   *
   *   Response:
   *   {
   *   "content": [
  ...
  @GetMapping
  public Page<CryptoTradeData> getCryptoTradeData(Pageable pageable) {
    return cryptoTradeDataService.getAllCryptoTradeInfo(pageable);
  }
}
